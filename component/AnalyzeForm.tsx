            ...
            <form onSubmit={handleSubmit(Onsubmit)}>
                <div className="flex flex-col md:flex-row gap-8 lg:flex-row">
                    <Card num={1} title="Genomic Data Upload" desc="Upload VCF file containing genetic variants">
                        <label className="border border-dashed border-gray-400 rounded-lg px-12 md:px-30 py-10 flex flex-col items-center cursor-pointer hover:border-teal-500 hover:bg-gray-100">
                            <input
                                type="file"
                                accept=".vcf"
                                hidden
                ...
                {mutation.isPending ? <div className="w-full mt-8 mb-5 flex items-center justify-center"><Loader className="animate-spin w-12 h-12 dark:text-white" /></div> :
